            ...
            <div class="flex justify-between gap-8">
                ...
                <div class="w-[75%] overflow-hidden">
                    ...
                    <div class="flex justify-between items-center py-6">
                        <!-- Greeting Area -->
                        <div class="px-2 text-gray-600 text-xl font-semibold">
                        ...
                        <div class="flex justify-end items-center space-x-4">
                            <div
                                class="bg-white p-2 rounded-md shadow-md text-[#343A40] text-sm flex items-center"
                            >
                                <CalendarDays class="h-4 w-4 mr-1" /> 19.12.2020
                                - 25.12.2020
                                <ChevronDown class="h-5 w-5 ml-5" />
                            </div>
                            <button
                                class="bg-[#27B3AA] py-2 px-4 rounded-md shadow-md text-white text-sm cursor-pointer"
                            >
                                Create New Survey
                            </button>
                        </div>
